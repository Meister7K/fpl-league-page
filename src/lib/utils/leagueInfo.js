/*   STEP 1   */
export const leagueID = "1124846398970298368"; // your league ID
export const leagueName = "Fantasy Premier League"; // your league name
...
export const homepageText = `
  <p>Welcome to the Fantasy Premier League. </p>
`;
...
export const managers = [
    {
      ...
      "bio": "Lorem ipsum...",
      "photo": "https://sleepercdn.com/images/v2/avatars/avatar_default_pink.webp", // square ratio recommended (no larger than 500x500)
    ...
    },
    {
      ...
      "location": "Denver, CO", // (optional)
      "bio": "Lorem ipsum...",
      "photo": "https://sleepercdn.com/uploads/61bd506e78bffe00f550d63a48b63031", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2018, // (optional) when did the manager start playing fantasy football
      ...
      "favoritePlayer": 4353, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
    ...
    },
    {
      ...
      "bio": "Lorem ipsum...",
      "photo": "https://sleepercdn.com/uploads/8d2a3fb5de73a816c2d879f0ae664af4.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2018, // (optional) when did the manager start playing fantasy football
    ...
    },
    {
      ...
      "bio": "Lorem ipsum...",
      "photo": "https://sleepercdn.com/uploads/9adc5bc396eb80db285d96226046dfbb.jpg", // square ratio recommended (no larger than 500x500)
      "fantasyStart": 2018, // (optional) when did the manager start playing fantasy football
      "favoriteTeam": "min", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
